...
from fuge.api.controllers import base as controllers_base
from fuge.api.controllers import link
from fuge.api.controllers.v1 import container
from fuge.api.controllers.v1 import services
...
class V1(controllers_base.APIBase):
    ...
    def convert():
        ...
        v1.media_types = [MediaType('application/json',
                          'application/vnd.openstack.fuge.v1+json')]
