...
from fuge.common import context as fuge_context
from fuge.objects import base as objects_base

from fuge.tests import conf_fixture
...
class TestCase(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.context = fuge_context.RequestContext(
        ...
        def make_context(*args, **kwargs):
            ...
            context = fuge_context.RequestContext(*args, **kwargs)
            return fuge_context.RequestContext.from_dict(context.to_dict())

        p = mock.patch.object(fuge_context, 'make_context',
        ...
        self._base_test_obj_backup = copy.copy(
            objects_base.FugeObjectRegistry._registry._obj_classes)
