...
from fuge.common.i18n import _LW
...
UTILS_OPTS = [
    cfg.StrOpt('rootwrap_config',
               default="/etc/fuge/rootwrap.conf",
...
def _get_root_helper():
    return 'sudo fuge-rootwrap %s' % CONF.rootwrap_config
...
def is_name_safe(name):
    ...
    # https://bugs.launchpad.net/fuge/+bug/1430617
    if not name:
        return False
    return True
