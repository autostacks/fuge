...
"""Common RPC service and API tools for Fuge."""
...
from fuge.common import rpc
from fuge.objects import base as objects_base
from fuge.servicegroup import service_periodic as servicegroup
...
class Service(service.Service):
    ...
    def __init__(self, topic, server, handlers, binary):
        ...
        serializer = rpc.RequestContextSerializer(
            objects_base.FugeObjectSerializer())
