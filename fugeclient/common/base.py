...
from fugeclient.common.apiclient import base
...
class Manager(object):
    ...
    def _list_pagination(self, url, response_key=None, obj_class=None,
        ...
        The Fuge API is configured to return a maximum number of
        items per request, (FIXME: see Fuge's api.max_limit option). This
