...
from fugeclient.common import base
from fugeclient.common import utils
from fugeclient import exceptions


CREATION_ATTRIBUTES = ['name', 'image', 'command', 'memory']
    ...
    def list(self, marker=None, limit=None, sort_key=None,
        ...
        :param limit: The maximum number of results to return per
            ...
            3) limit param is NOT specified (None), the number of items
               returned respect the maximum imposed by the Fuge API
               (see Fuge's api.max_limit option).
        ...
        if limit is None:
            ...
            # TODO(yuanying): if endpoint returns "map",
            # change None to response_key
            return self._list_pagination(self._path(path), "containers", limit=limit)
